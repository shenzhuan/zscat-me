...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("com.stylefeng.guns.common.controller.BaseController");
        imports.add("com.stylefeng.guns.modular.system.warpper.NullWarpper");
        ...
        imports.add("com.stylefeng.guns.modular." + contextConfig.getModuleName() + ".servicr.I" + contextConfig.getBizEnBigName()+"Service");
